            ...
            <ul class="am-list admin-content-task">
              ...
              <li>
                ...
                <div class="am-cf">
                  ...
                  <div class="am-panel am-panel-default">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-3'}">留言信息<span class="am-icon-chevron-down am-fr" >&nbsp;&nbsp;<a href="<?php echo U('Admin/News/add');?>">编辑</a></span> </div>
          <div class="am-panel-bd am-collapse am-in am-cf" id="collapse-panel-3">

            <?php if(is_array($res)): foreach($res as $key=>$val): ?><ul class="am-comments-list admin-content-comment">
                <li class="am-comment">
                  ...
                  <div class="am-comment-main">
                    <header class="am-comment-hd">
                      <div class="am-comment-meta"><a href="#" class="am-comment-author"><?php echo ($val['adn_id']); ?></a> 发布于 <time><?php echo ($val['nes_time']); ?></time></div>
                    </header>
                    <div class="am-comment-bd"><p><?php echo ($val['nes_detail']); ?></p>
                    </div>
                  </div>
                </li>
